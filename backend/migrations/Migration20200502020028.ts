...
export class Migration20200502020028 extends Migration {
  async up(): Promise<void> {
     ...
     */
    this.addSql(
      'alter table "form" drop constraint if exists "form_updated_at_check";',
    );
    this.addSql(
    ...
    this.addSql(
      'alter table "form_character" drop constraint if exists "form_character_updated_at_check";',
    );
    this.addSql(
      'alter table "form_character" alter column "updated_at" type timestamptz(0) using ("updated_at"::timestamptz(0));',
    );
    this.addSql(
      'alter table "form_character" alter column "updated_at" drop default;',
    );
    this.addSql(
    ...
    this.addSql(
      'alter table "form_character" alter column "submission_id" drop not null;',
    );

    this.addSql(
      'alter table "form_question" drop constraint if exists "form_question_file_types_check";',
    );
    this.addSql(
