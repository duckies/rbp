...
import * as IGameData from './interfaces';
...
export type GameDataReturnType = {
  ...
  [GameDataEndpoint.ItemMedia]: IGameData.GameDataItemMedia;
...
export class GameDataService {
  ...
  // Vanilla getGameItemMedia()
  // async getGameItemMedia(id: number): Promise<IGameData.GameDataItemMedia> {
  //   return this.getGameData(GameDataEndpoint.ItemMedia, id);
  // }

  async getGameItemMedia(id: number, download?: boolean): Promise<IGameData.GameDataItemMedia> {
