<template>
  <div>
    <v-card v-if="!blizzard" class="left-border-rounded mb-4">
    ...
    <v-card
      v-else
      :class="`left-border-rounded character class-border-${blizzard.class_id} class-logo-${blizzard.class_id} mb-4`"
    >
      <v-card-text class="ma-0 pa-0">
        <v-layout wrap class="render--wrapper">
          <v-row no-gutters>
            <v-col cols="auto" class="ma-7">
              <v-row class="flex-column fill-height" no-gutters align="center" justify="center">
                ...
                <div class="character--links">
                  <a
                    :href="`https://www.worldofwarcraft.com/en-us/character/${region}/${realm}/${name}`"
                    target="_blank"
                  >
            ...
            <v-col cols="12" sm="12" lg="12" xl="4" class="pa-4">
        ...
        <v-layout>
          <v-row v-if="!applying" no-gutters>
            <v-col>
              <div class="character--footer">
                <span class="character--updated">{{ lastUpdated }}</span>
              </div>
            </v-col>
          </v-row>
        </v-layout>
